    ...
    return (
        <div className={cn("sticky top-80", className)}>
            <p className="text-lg md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300">
                {title || `Simplify your life with Syncupia`}
            </p>
            <p className="text-xs md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto">
                {description ||
                    `A new way to streamline your workflows into one cohesive environment!`}
            </p>
            <div className="w-full h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
                <button className="font-bold hover:bg-indigo-200 bg-white rounded-full md:px-7 md:py-5 px-2 py-1 md:mt-24 mt-8 z-30 md:text-base text-black text-sm w-fit mx-auto ">
...
export function GeminiEffectDemo() {
    ...
    return (
        <div className="h-[400vh] bg-neutral-950 w-screen rounded-md relative pt-40 overflow-clip"
            ref={ref}
        >
            <GeminiEffect
                pathLengths={[
